...
export type ClientOptions = {
    baseUrl: 'https://api.vtex.com/{accountName}' | 'https://api.vtex.com/{account}/pricing' | 'https://api.vtex.com/{account}/pricing' | 'https://api.vtex.com/{account}/pricing' | 'https://api.vtex.com/{account}/pricing' | 'https://api.vtex.com/{account}/pricing' | 'https://api.vtex.com/{account}/pricing' | 'https://api.vtex.com/{account}/pricing' | (string & {});
};
...
export type Getcomputedprice = {
    ...
    /**
     * Price table associated with the computed price. This field is only present when the price is associated with a specific price table.
     */
    priceTable?: string;
};
...
export type GetPricingPricesByItemIdComputedData = {
    body?: never;
    headers: {
        /**
         * Type of the content being sent.
...
export type GetPricingPricesByItemIdComputedResponses = {
    /**
     * List of computed prices for the SKU across all applicable price tables and trade policies.
     */
    200: Array<Getcomputedprice>;
};

export type GetPricingPricesByItemIdComputedResponse = GetPricingPricesByItemIdComputedResponses[keyof GetPricingPricesByItemIdComputedResponses];
