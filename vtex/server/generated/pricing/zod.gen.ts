...
export const zGetcomputedprice = z.object({
    ...
    priceTable: z.optional(z.string().register(z.globalRegistry, {
        description: 'Price table associated with the computed price. This field is only present when the price is associated with a specific price table.'
    }))
}).register(z.globalRegistry, {
...
export const zGetPricingPricesByItemIdComputedData = z.object({
    ...
    query: z.optional(z.object({
        categoryIds: z.optional(z.int().register(z.globalRegistry, {
