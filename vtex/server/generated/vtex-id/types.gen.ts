...
export type ClientOptions = {
    baseUrl: 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com' | 'https://{storeDomain}' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{accountName}.{environment}.com.br' | 'https://{storeDomain}' | 'https://{accountName}.{environment}.com' | 'https://{storeDomain}' | 'https://{accountName}.{environment}.com' | 'https://{storeDomain}' | 'https://{accountName}.{environment}.com' | 'https://{storeDomain}' | 'https://{accountName}.{environment}.com' | (string & {});
};
...
export type PostApiAuthenticatorV1StorefrontUsersData = {
    body?: {
        /**
...
export type PostApiAuthenticatorV1StorefrontUsersErrors = {
    /**
     * Bad Request
     *
...
export type PostApiAuthenticatorV1StorefrontUsersError = PostApiAuthenticatorV1StorefrontUsersErrors[keyof PostApiAuthenticatorV1StorefrontUsersErrors];

export type PostApiAuthenticatorV1StorefrontUsersResponses = {
    /**
     * Created
     *
...
export type PostApiAuthenticatorV1StorefrontUsersResponse = PostApiAuthenticatorV1StorefrontUsersResponses[keyof PostApiAuthenticatorV1StorefrontUsersResponses];

export type DeleteApiAuthenticatorV1TenantsFeaturesByNameData = {
    body?: never;
    headers: {
        /**
         * HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
    ...
    path: {
        /**
         * Feature name for password migration. Must be `PasswordMigration`.
         */
        name: string;
    };
    query?: never;
...
export type DeleteApiAuthenticatorV1TenantsFeaturesByNameErrors = {
    /**
     * Bad Request
     *
...
export type DeleteApiAuthenticatorV1TenantsFeaturesByNameResponses = {
    /**
     * No Content
     *
...
export type DeleteApiAuthenticatorV1TenantsFeaturesByNameResponse = DeleteApiAuthenticatorV1TenantsFeaturesByNameResponses[keyof DeleteApiAuthenticatorV1TenantsFeaturesByNameResponses];

export type PatchApiAuthenticatorV1TenantsFeaturesByNameData = {
    body?: {
        /**
         * Flag to enable (`true`) or disable (`false`) the password migration feature. When disabled, legacy password validation will not be performed.
         */
        enabled: boolean;
    };
    headers: {
...
export type PatchApiAuthenticatorV1TenantsFeaturesByNameErrors = {
    /**
     * Bad Request
     *
     * Unknown feature name.
...
export type PatchApiAuthenticatorV1TenantsFeaturesByNameResponses = {
    /**
     * OK
     *
...
export type PutApiAuthenticatorV1TenantsFeaturesByNameData = {
    body?: {
        /**
         * Public identifier used to select the correct shared secret on the middleware side. This identifier is included in the `X-VTEX-Client-Id` header of authentication requests sent to the middleware.
         */
        clientId: string;
        /**
         * HTTPS URL of the authentication middleware endpoint that VTEX will call to validate legacy credentials. The path must end with `/authentication`. Example: `https://your-middleware.com/authentication`.
         */
        idpEndpoint: string;
        /**
         * Shared secret used to authenticate VTEX requests to the middleware via HMAC-SHA256 signatures. This should be a high-entropy value (recommended: 32+ random bytes / 256-bit, encoded as Base64). Treat this as a sensitive credential: do not log it, do not share it, and do not reuse it across environments.
         */
        secret: string;
    };
    headers: {
...
export type PutApiAuthenticatorV1TenantsFeaturesByNameErrors = {
    /**
     * Bad Request
     *
...
export type PutApiAuthenticatorV1TenantsFeaturesByNameResponses = {
    /**
     * OK
     *
...
export type DeleteApiVtexidOrganizationUnitsByUnitIdSettingsData = {
    /**
     * Payload listing authentication configuration types to delete for the organization unit.
     */
    body: {
        /**
         * Authentication configuration entries to delete.
         */
        settings: Array<{
            /**
             * Authentication configuration category to delete.
             */
            type: 'OAuth' | 'Password';
        }>;
    };
    ...
    path: {
        /**
         * Unique identifier (GUID) of the organization unit from which the listed authentication settings will be deleted.
         */
        unitId: string;
    };
    query?: never;
...
export type DeleteApiVtexidOrganizationUnitsByUnitIdSettingsErrors = {
    /**
     * Error payload when the request is invalid or settings cannot be deleted.
     */
    400: {
        /**
         * Explanation of why the request failed validation or settings could not be removed.
         */
        message?: string;
    };
    /**
     * Error payload when the authenticated user cannot be resolved.
     */
    401: {
        /**
         * Explanation of why the request is unauthorized.
         */
        message?: string;
    };
    /**
     * Error payload when the caller is not allowed to perform this operation.
     */
    403: {
        /**
    ...
    /**
     * Error payload when the organization unit cannot be found or the path parameter is invalid.
     */
    404: {
        /**
         * Explanation of why the resource was not found.
         */
        message?: string;
    };
    /**
     * Error payload when the server fails to process the request.
     */
    500: {
        /**
         * Explanation of the server error.
         */
        message?: string;
    };
};

export type DeleteApiVtexidOrganizationUnitsByUnitIdSettingsError = DeleteApiVtexidOrganizationUnitsByUnitIdSettingsErrors[keyof DeleteApiVtexidOrganizationUnitsByUnitIdSettingsErrors];

export type DeleteApiVtexidOrganizationUnitsByUnitIdSettingsResponses = {
    /**
     * No Content
     *
...
export type DeleteApiVtexidOrganizationUnitsByUnitIdSettingsResponse = DeleteApiVtexidOrganizationUnitsByUnitIdSettingsResponses[keyof DeleteApiVtexidOrganizationUnitsByUnitIdSettingsResponses];

export type GetApiVtexidOrganizationUnitsByUnitIdSettingsData = {
    body?: never;
    headers: {
        /**
         * HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.
    ...
    path: {
        /**
         * Unique identifier (GUID) of the organization unit whose authentication settings are being read.
         */
        unitId: string;
    };
    query?: never;
...
export type GetApiVtexidOrganizationUnitsByUnitIdSettingsErrors = {
    /**
     * Error payload when the authenticated user cannot be resolved.
     */
    401: {
    ...
    /**
     * Error payload when the caller is not allowed to access this resource.
     */
    403: {
        /**
         * Explanation of why access was denied.
...
export type GetApiVtexidOrganizationUnitsByUnitIdSettingsError = GetApiVtexidOrganizationUnitsByUnitIdSettingsErrors[keyof GetApiVtexidOrganizationUnitsByUnitIdSettingsErrors];

export type GetApiVtexidOrganizationUnitsByUnitIdSettingsResponses = {
    /**
     * Authentication settings for the organization unit.
     */
    200: {
        /**
         * List of authentication methods available for the organization unit.
         */
        authenticationMethods: Array<{
            /**
             * Machine-readable authentication method type: `Password` for password login or `OAuth` for SSO through an external identity provider.
             */
            type: 'Password' | 'OAuth';
            /**
             * Human-readable label of the method, such as the configured identity provider name.
             */
            name: string;
            /**
             * Whether the method is enabled for this organization unit.
             */
...
export type GetApiVtexidOrganizationUnitsByUnitIdSettingsResponse = GetApiVtexidOrganizationUnitsByUnitIdSettingsResponses[keyof GetApiVtexidOrganizationUnitsByUnitIdSettingsResponses];

export type PatchApiVtexidOrganizationUnitsByUnitIdSettingsData = {
    /**
     * Payload listing existing authentication configuration entries to update by type and target status.
     */
    body: {
        /**
         * Authentication configuration entries to partially update for the organization unit.
         */
        settings: Array<{
            /**
             * Authentication configuration category to update.
             */
            type: 'OAuth';
            /**
             * Target status for the configuration.
             */
            status: 'Enabled' | 'Disabled';
        }>;
    };
    ...
    path: {
        /**
         * Unique identifier (GUID) of the organization unit whose authentication settings are being patched.
         */
        unitId: string;
    };
    query?: never;
...
export type PatchApiVtexidOrganizationUnitsByUnitIdSettingsErrors = {
    /**
     * Error payload when the request is invalid or existing settings cannot be updated.
     */
    400: {
        /**
         * Explanation of why the request failed validation or could not be applied.
         */
        message?: string;
    };
    /**
...
export type PatchApiVtexidOrganizationUnitsByUnitIdSettingsError = PatchApiVtexidOrganizationUnitsByUnitIdSettingsErrors[keyof PatchApiVtexidOrganizationUnitsByUnitIdSettingsErrors];

export type PatchApiVtexidOrganizationUnitsByUnitIdSettingsResponses = {
    /**
     * Authentication settings for the organization unit.
     */
    200: {
...
export type PatchApiVtexidOrganizationUnitsByUnitIdSettingsResponse = PatchApiVtexidOrganizationUnitsByUnitIdSettingsResponses[keyof PatchApiVtexidOrganizationUnitsByUnitIdSettingsResponses];

export type PostApiVtexidOrganizationUnitsByUnitIdSettingsData = {
    /**
     * Payload listing authentication methods to update by display name and status.
     */
    body: {
        /**
         * Authentication methods to update for the organization unit.
         */
        settings: Array<{
            /**
             * Machine-readable authentication method type: `Password` for password login or `OAuth` for SSO through an external identity provider.
            ...
            type: 'Password' | 'OAuth';
            /**
             * Display name of the authentication method to update, as returned by `GET` [Get organization unit authentication settings](https://developers.vtex.com/docs/api-reference/vtex-id-api#get-/api/vtexid/organization-units/-unitId-/settings) (for example the identity provider name for SSO).
             */
            name: string;
            /**
             * Target status for the method.
             */
            status: 'Enabled' | 'Disabled';
        }>;
    };
    ...
    path: {
        /**
         * Unique identifier (GUID) of the organization unit whose authentication settings are being updated.
         */
        unitId: string;
    };
    query?: never;
...
export type PostApiVtexidOrganizationUnitsByUnitIdSettingsErrors = {
    /**
     * Error payload when the request body does not describe a valid authentication configuration.
     */
    400: {
        /**
    ...
    /**
     * Conflict error details when settings already exist for one or more authentication methods.
     */
    409: {
        /**
...
export type PostApiVtexidOrganizationUnitsByUnitIdSettingsError = PostApiVtexidOrganizationUnitsByUnitIdSettingsErrors[keyof PostApiVtexidOrganizationUnitsByUnitIdSettingsErrors];

export type PostApiVtexidOrganizationUnitsByUnitIdSettingsResponses = {
    /**
     * Acknowledgement of a successful update.
     */
    200: {
        /**
         * Indicates that the update completed without errors.
         */
        success?: boolean;
    };
};

export type PostApiVtexidOrganizationUnitsByUnitIdSettingsResponse = PostApiVtexidOrganizationUnitsByUnitIdSettingsResponses[keyof PostApiVtexidOrganizationUnitsByUnitIdSettingsResponses];
