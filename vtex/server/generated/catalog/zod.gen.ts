...
export const zGetSkuAltId = z.object({
    ...
    SalesChannels: z.array(z.int().register(z.globalRegistry, {
        ...
        description: 'Array of sales channel IDs.'
    }),
    Images: z.array(zImage).register(z.globalRegistry, {
...
export const zProductAssortment = z.object({
    Id: z.optional(z.int().register(z.globalRegistry, {
        description: 'Assortment\'s unique numerical identifier.'
    })),
    Name: z.optional(z.string().register(z.globalRegistry, {
        description: 'Assortment\'s unique name.'
    })),
    CreatedAt: z.optional(z.iso.datetime().register(z.globalRegistry, {
        description: 'Date and time when the assortment was created, in UTC format.'
    })),
    UpdatedAt: z.optional(z.iso.datetime().register(z.globalRegistry, {
        description: 'Date and time when the assortment was last updated, in UTC format.'
    })),
    IncludedCollections: z.optional(z.array(z.int().register(z.globalRegistry, {
        description: 'Included collection\'s unique numerical identifier.'
    })).register(z.globalRegistry, {
        description: 'List of collection IDs explicitly allowed by the assortment.'
    })),
    ExcludedCollections: z.optional(z.array(z.int().register(z.globalRegistry, {
        description: 'Excluded collection\'s unique numerical identifier.'
    })).register(z.globalRegistry, {
        description: 'List of collection IDs explicitly restricted by the assortment.'
    }))
}).register(z.globalRegistry, {
    description: 'Object with information about a product assortment.'
});
...
export const zAssortmentCollectionAssociation = z.object({
    assortmentId: z.optional(z.int().register(z.globalRegistry, {
        description: 'Assortment\'s unique identifier.'
    })),
    collectionId: z.optional(z.int().register(z.globalRegistry, {
        description: 'Collection\'s unique identifier associated with the assortment.'
    }))
}).register(z.globalRegistry, {
    description: 'Object with information about the association between an assortment and a collection.'
});
...
export const zErrorResponse = z.object({
    Message: z.optional(z.string().register(z.globalRegistry, {
        description: 'Error message describing the reason the request failed.'
    }))
}).register(z.globalRegistry, {
    description: 'Object with information about the error.'
});
 ...
 */
export const zProductAssortmentId = z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
    description: 'Product assortment\'s unique numerical identifier.'
});

/**
 * Collection's unique numerical identifier.
 */
export const zCollectionId2 = z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
...
export const zSkuContextData = z.object({
    ...
    query: z.optional(z.object({
        sc: z.optional(z.int().register(z.globalRegistry, {
            description: 'Sales channel\'s unique identifier number.'
        }))
    })),
    headers: z.object({
        'Content-Type': z.string().register(z.globalRegistry, {
...
export const zPostApiCatalogPvtStockkeepingunitBySkuIdAttributeData = z.object({
    body: z.optional(z.object({
        SpecificationName: z.string().register(z.globalRegistry, {
            description: 'Name of the SKU attribute. This is an open-text field.'
        }),
        SpecificationValue: z.string().register(z.globalRegistry, {
            description: 'Value of the SKU attribute. This is an open-text field with a maximum length of 3,500 characters. Avoid characters that break the JSON string (for example, unescaped backslashes), as they will cause a status code `400` error.'
        }),
        IsVisible: z.optional(z.boolean().register(z.globalRegistry, {
            description: 'Defines if the attribute is visible on the store (`true`) or not (`false`).'
        }))
    })),
    path: z.object({
        skuId: z.int().register(z.globalRegistry, {
...
export const zDeleteApiCatalogPvtStockkeepingunitBySkuIdAttributeBySkuAttributeIdData = z.object({
    ...
    path: z.object({
        ...
        skuAttributeId: z.int().register(z.globalRegistry, {
            description: 'SKU attribute unique numerical identifier.'
        })
    }),
    query: z.optional(z.never()),
    headers: z.object({
...
export const zPutApiCatalogPvtStockkeepingunitBySkuIdAttributeBySkuAttributeIdData = z.object({
    body: z.optional(z.object({
        ...
        SpecificationValue: z.string().max(3500).register(z.globalRegistry, {
            description: 'Value of the SKU attribute. This is an open-text field with a maximum length of 3,500 characters. Avoid characters that break the JSON string (for example, unescaped backslashes), as they will cause a status code `400` error.'
        }),
        IsVisible: z.optional(z.boolean().register(z.globalRegistry, {
            description: 'Defines if the attribute is visible on the store (`true`) or not (`false`).'
...
export const zGetProductsfromacollectionData = z.object({
    ...
    query: z.optional(z.object({
        ...
        SalesChannelId: z.optional(z.int().register(z.globalRegistry, {
            description: 'Product\'s sales channel unique identifier.'
        })),
...
export const zDeleteApiCatalogPvtProductByProductIdSalespolicyByTradepolicyIdData = z.object({
    ...
    path: z.object({
        ...
        tradepolicyId: z.int().register(z.globalRegistry, {
            description: 'Sales channel\'s unique numerical identifier.'
        })
    }),
    query: z.optional(z.never()),
    headers: z.object({
...
export const zGetApiCatalogSystemPvtSkuStockkeepingunitidsbysaleschannelData = z.object({
    ...
    query: z.object({
        ...
        onlyAssigned: z.optional(z.boolean().register(z.globalRegistry, {
            description: 'If set as `false`, it allows the user to decide if the SKUs that are not assigned to a specific sales channel should be also returned.'
        }))
    }),
    headers: z.object({
        'Content-Type': z.string().register(z.globalRegistry, {
...
export const zGetApiCatalogPvtAssortmentData = z.object({
    ...
    query: z.optional(z.object({
        name: z.optional(z.string().register(z.globalRegistry, {
            description: 'Assortment name.'
        })),
        after: z.optional(z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
            description: 'Cursor indicating the assortment ID after which the next page of results must start. Useful for cursor-based pagination.'
        })),
        size: z.optional(z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
            description: 'Maximum number of assortments returned in the response when using cursor-based pagination.'
        })),
        collectionId: z.optional(z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
            description: 'Filters the result to return only assortments that reference the specified collection ID, either as an included or as an excluded collection.'
        }))
    })),
    headers: z.object({
        Accept: z.string().register(z.globalRegistry, {
...
export const zPostApiCatalogPvtAssortmentData = z.object({
    body: z.optional(z.object({
        name: z.string().register(z.globalRegistry, {
            description: 'Assortment\'s unique name at the merchant level.'
        })
    })),
    path: z.optional(z.never()),
    query: z.optional(z.never()),
...
export const zDeleteApiCatalogPvtAssortmentByProductAssortmentIdData = z.object({
    body: z.optional(z.never()),
    path: z.object({
        productAssortmentID: z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
            description: 'Product assortment\'s unique numerical identifier.'
        })
    }),
    query: z.optional(z.never()),
...
export const zPutApiCatalogPvtAssortmentByProductAssortmentIdData = z.object({
    body: z.optional(z.object({
        name: z.string().register(z.globalRegistry, {
            description: 'Assortment\'s new unique name. Must not collide with existing assortments at the merchant level.'
        })
    })),
    path: z.object({
        productAssortmentID: z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
...
export const zDeleteApiCatalogPvtAssortmentByProductAssortmentIdIncludedCollectionsByCollectionIdData = z.object({
    ...
    path: z.object({
        ...
        collectionID: z.int().min(-2147483648, { error: 'Invalid value: Expected int32 to be >= -2147483648' }).max(2147483647, { error: 'Invalid value: Expected int32 to be <= 2147483647' }).register(z.globalRegistry, {
            description: 'Collection\'s unique numerical identifier.'
        })
    }),
    query: z.optional(z.never()),
