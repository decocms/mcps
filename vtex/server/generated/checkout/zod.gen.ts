...
export const zOrderForm = z.object({
    ...
    items: z.optional(z.array(z.object({
        ...
        attachments: z.optional(z.array(z.object({
            ...
            content: z.optional(z.record(z.string(), z.unknown()).register(z.globalRegistry, {
                description: 'Object containing the attachment content as key-value pairs.'
            }))
        }).register(z.globalRegistry, {
        ...
        z.object({
            ...
            logisticsInfo: z.optional(z.array(z.object({
                ...
                slas: z.optional(z.array(z.object({
                    id: z.optional(z.string().register(z.globalRegistry, {
                        description: 'SLA ID. If the store uses the [Delivery Options](https://help.vtex.com/en/docs/tutorials/delivery-options-beta) feature, this field returns the delivery option ID selected for this SLA, as the example `1223d5b4-52a4-442f-ab23-01345b60be48`.'
                    })),
                    deliveryChannel: z.optional(z.string().register(z.globalRegistry, {
                        description: 'Delivery channel.'
                    })),
                    name: z.optional(z.string().register(z.globalRegistry, {
                        description: 'SLA name. If the store uses the [Delivery Options](https://help.vtex.com/en/docs/tutorials/delivery-options-beta) feature, the value of this field will show the specific delivery option name selected for this SLA, as the example `Delivery | BRA | Up to 30 hours`.'
                    })),
                    ...
                    shippingEstimate: z.optional(z.string().register(z.globalRegistry, {
                        description: 'Shipping estimate. For instance, "three business days" will be represented as `3bd`. The unit can be `bd` for business days, `d` for days, `h` for hours, or `m` for minutes.'
                    })),
                    ...
                    pickupDistance: z.optional(z.number().register(z.globalRegistry, {
            ...
            availableAddresses: z.optional(z.array(z.object({
                ...
                isDisposable: z.optional(z.boolean().register(z.globalRegistry, {
                    description: 'Indicates whether the address is disposable. Addresses marked as `isDisposable = true` are not saved to the shopper\'s profile when the order is completed, while addresses with `isDisposable = false` are saved.\r\n\r\nBehavior by address type:\r\n- `giftRegistry`, `pickup`, `search`, and `inStore`: always disposable, as they do not belong to the shopper navigating the cart.\r\n- `residential`: may be disposable. Addresses from a complete shopper profile, or entered by an authenticated shopper with a complete profile, are not disposable. All other residential addresses are disposable, including those from first-time purchases, since no complete profile exists yet.\r\n- `invoice`: does not have the `isDisposable` flag, since invoice addresses are of type `Address` rather than `ShippingAddress`. In practice, only authenticated shoppers can add invoice attachments to the cart, so they are never treated as disposable.\r\n- `commercial`: corresponds to company addresses used in B2B contexts and follows the same logic as residential addresses.\r\n\r\nWhen a residential address is marked as disposable and the profile is complete, authentication is required to complete the order. Additionally, when a disposable residential address is used to complete a purchase, saved cards cannot be used.'
                })),
                postalCode: z.optional(z.string().register(z.globalRegistry, {
                    description: 'Postal code.'
                })),
...
export const zCartSimulationData = z.object({
    body: z.optional(z.object({
        ...
        allowedOutdatedData: z.optional(z.array(z.enum([
            ...
            description: 'Array of allowed data that can be skipped in the cart simulation.'
        }))
    })),
...
export const zDeleteApiCheckoutPubOrderFormByOrderFormIdItemsByItemIndexPriceData = z.object({
    ...
    path: z.object({
        orderFormId: z.string().register(z.globalRegistry, {
            description: 'ID of the orderForm corresponding to the cart whose item will have the manual price deleted.'
        }),
...
export const zDeleteApiCheckoutPubOrderFormByOrderFormIdItemsByItemIndexAttachmentsByAttachmentNameData = z.object({
    ...
    path: z.object({
        orderFormId: z.string().register(z.globalRegistry, {
            description: 'ID of the orderForm corresponding to the cart whose item will have the attachment removed.'
        }),
        itemIndex: z.string().register(z.globalRegistry, {
            description: 'The index of the item in the cart that will have the attachment removed. Each cart item is identified by an index, starting in 0.'
        }),
        attachmentName: z.string().register(z.globalRegistry, {
            description: 'Name of the attachment that will be removed from the item. It must match one of the attachment schemas available for the item, listed in the `attachmentOfferings` field of the orderForm.'
        })
    }),
    query: z.optional(z.object({
        individualShippingEstimates: z.optional(z.boolean().register(z.globalRegistry, {
...
export const zPostApiCheckoutPubOrderFormByOrderFormIdItemsByItemIndexAttachmentsByAttachmentNameData = z.object({
    body: z.object({
        content: z.record(z.string(), z.unknown()).register(z.globalRegistry, {
            description: 'Object containing the attachment\'s key-value pairs, where each key is a field defined by the attachment schema and each value is the content to be set for that field.'
        })
    }),
    path: z.object({
        orderFormId: z.string().register(z.globalRegistry, {
            description: 'ID of the orderForm corresponding to the cart whose item will receive the attachment.'
        }),
        itemIndex: z.string().register(z.globalRegistry, {
            description: 'The index of the item in the cart that will receive the attachment. Each cart item is identified by an index, starting in 0.'
        }),
        attachmentName: z.string().register(z.globalRegistry, {
            description: 'Name of the attachment that will be added to the item. It must match one of the attachment schemas available for the item, listed in the `attachmentOfferings` field of the orderForm.'
        })
    }),
    query: z.optional(z.object({
        individualShippingEstimates: z.optional(z.boolean().register(z.globalRegistry, {
...
export const zDeleteApiCheckoutPubOrderFormByOrderFormIdAttachmentsSubscriptionDataData = z.object({
    body: z.object({
        subscriptions: z.array(z.record(z.string(), z.unknown()).register(z.globalRegistry, {
            description: 'Subscription information for a given cart item.'
        })).register(z.globalRegistry, {
            description: 'List of the item subscriptions in the cart. To remove all subscription information from the cart, send an empty array.'
        })
    }),
    path: z.object({
        orderFormId: z.string().register(z.globalRegistry, {
            description: 'ID of the orderForm corresponding to the cart that will have the subscription information removed.'
        })
    }),
    query: z.optional(z.object({
        individualShippingEstimates: z.optional(z.boolean().register(z.globalRegistry, {
    ...
    body: z.object({
        subscriptions: z.array(z.object({
            itemIndex: z.int().register(z.globalRegistry, {
                description: 'Index that identifies the cart item the subscription refers to. Each cart item is identified by an index, starting in 0.'
            }),
            plan: z.object({
                frequency: z.object({
                    interval: z.int().register(z.globalRegistry, {
                        description: 'Numerical interval between each subscription order, according to the chosen `periodicity`.'
                    }),
                    periodicity: z.string().register(z.globalRegistry, {
                        description: 'Time unit for the subscription frequency. Possible values are `DAY`, `WEEK`, `MONTH`, and `YEAR`.'
                    })
                }).register(z.globalRegistry, {
                    description: 'Object containing the frequency in which the subscription order will be placed.'
                }),
                validity: z.optional(z.object({
                    begin: z.optional(z.string().register(z.globalRegistry, {
                        description: 'Date when the subscription becomes valid, in the `YYYY-MM-DD` format.'
                    })),
                    end: z.optional(z.string().register(z.globalRegistry, {
                        description: 'Date when the subscription expires, in the `YYYY-MM-DD` format.'
                    }))
                }).register(z.globalRegistry, {
                    description: 'Object containing the period in which the subscription is valid.'
                })),
                type: z.string().register(z.globalRegistry, {
                    description: 'Type of the subscription plan.'
                })
            }).register(z.globalRegistry, {
                description: 'Object containing the subscription plan information.'
            })
        }).register(z.globalRegistry, {
            description: 'Subscription information for a given cart item.'
        })).register(z.globalRegistry, {
            description: 'List of the item subscriptions to be attached to the cart.'
        })
    }),
    path: z.object({
        orderFormId: z.string().register(z.globalRegistry, {
            description: 'ID of the orderForm corresponding to the cart that will receive the subscription information.'
        })
    }),
    query: z.optional(z.object({
        individualShippingEstimates: z.optional(z.boolean().register(z.globalRegistry, {
        ...
        shippingData: z.union([
            z.object({
                ...
                logisticsInfo: z.optional(z.array(z.object({
                    ...
                    shippingEstimate: z.optional(z.string().register(z.globalRegistry, {
                        description: 'Estimated time until delivery for the item. The unit can be `bd` for business days, `d` for days, `h` for hours, or `m` for minutes.'
                    })),
