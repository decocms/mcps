...
export const zUpdateContractRequest = z.object({
    ...
    restrictions: z.optional(z.object({
        'vtex.catalog': z.optional(z.object({
            assortmentIds: z.optional(z.array(z.string().register(z.globalRegistry, {
                description: 'Unique identifier of a product assortment.'
            })).register(z.globalRegistry, {
                description: 'IDs of product assortments authorized for this contract (maximum of 20). An assortment is a reusable, merchant-level catalog profile, built from inclusion and exclusion collections, that controls which SKUs buyers can browse and purchase. This field defines the allowlist at the contract level. When empty, buyers fall back to the Sales Channel catalog associated with their navigation context. Organization Unit managers select one active assortment from this allowlist for their unit. Assortments supersede the legacy `collectionIds` restriction.'
            }))
        }).register(z.globalRegistry, {
            description: 'Contains catalog restrictions for the contract.'
        })),
