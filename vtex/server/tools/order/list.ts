        ...
        list: z.array(
          z
            .object({
              ...
              statusDescription: z
                .string()
                .describe("Human-readable order status"),
              ...
              workflowInRetry: z
                .boolean()
                .describe("Whether workflow is retrying"),
              lastMessageUnread: z
                .string()
                .nullable()
              ...
              orderIsComplete: z
                .boolean()
                .describe("Whether order is complete"),
              ...
              currencyCode: z
                .string()
                .describe("Currency code (BRL, USD, etc)"),
              ...
              isAnyDelivered: z
                .boolean()
                .describe("Whether any item is delivered"),
              giftCardProviders: z
                .array(z.any())
                .nullable()
