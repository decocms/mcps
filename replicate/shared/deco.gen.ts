...
export type Array_7 = String_29[];
export type String_30 = string;
export type String_31 = "none" | "open" | "autoPin";
...
export interface Object_4 {
  ...
  icon: String_25;
  url?: String_26;
  mimeTypePattern?: String_27;
  resourceName?: String_28;
  tools?: Array_7;
  prompt?: String_30;
  installBehavior?: String_31;
}
...
export interface GET_MODELOutput {
  ...
  visibility: String_36;
  run_count: Number_5;
  cover_image_url?: String_37;
  url: String_38;
  github_url?: String_39;
  paper_url?: String_40;
  license_url?: String_41;
  latest_version?: Object_5;
  default_example?: Object_7;
}
/**
...
export interface Object_5 {
  ...
  cog_version: String_44;
  openapi_schema: Object_6;
}
/**
...
export interface GET_PREDICTIONOutput {
  ...
  version: String_53;
  input: Object_11;
  created_at: String_54;
  started_at?: String_55;
  completed_at?: String_56;
}
/**
 * Performance metrics
 */
export interface Object_9 {
  predict_time?: Number_6;
}
/**
...
export type StringNull = String_58 | Null;
export type String_58 = string;
export type Null = null;
export type StringNull_1 = String_59 | Null_1;
...
export interface Object_12 {
  ...
  run_count: Number_7;
  cover_image_url?: String_67;
  url: String_68;
  latest_version?: Object_13;
}
/**
...
export interface Env {
  ...
  SELF: Mcp<{
    ...
    /**
     * List available models from Replicate. You can filter by owner (user or organization) to see their models. Returns model metadata including name, description, run count, and latest version info. Use the next_cursor from the response to paginate through results.
     */
...
export const Scopes = {
  REPLICATE_API_CONTRACT: {
    CONTRACT_AUTHORIZE: "REPLICATE_API_CONTRACT::CONTRACT_AUTHORIZE",
    CONTRACT_GET: "REPLICATE_API_CONTRACT::CONTRACT_GET",
    CONTRACT_SETTLE: "REPLICATE_API_CONTRACT::CONTRACT_SETTLE",
    DECO_CHAT_OAUTH_START: "REPLICATE_API_CONTRACT::DECO_CHAT_OAUTH_START",
  },
};
