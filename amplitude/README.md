...
- 📊 Read charts and dashboard definitions
- 🔍 Explore your event taxonomy and user properties

## Authentication

Authentication is handled via OAuth through the MCP connection. Connect using the URL `https://mcp.amplitude.com/mcp` and authorize with your Amplitude account.
