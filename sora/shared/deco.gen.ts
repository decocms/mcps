...
export const Scopes = {
  SORA2_CONTRACT: {
    CONTRACT_AUTHORIZE: "SORA2_CONTRACT::CONTRACT_AUTHORIZE",
    CONTRACT_GET: "SORA2_CONTRACT::CONTRACT_GET",
    CONTRACT_SETTLE: "SORA2_CONTRACT::CONTRACT_SETTLE",
    DECO_CHAT_OAUTH_START: "SORA2_CONTRACT::DECO_CHAT_OAUTH_START",
  },
  FILE_SYSTEM: {
