...
export const StateSchema = z.object({
  APIFY_CONTRACT: z.object({
    value: z.string(),
    __type: z
      .literal("@deco/apify-ed48e48556ae3c01cbe8a3cf3a1a34ae")
      .default("@deco/apify-ed48e48556ae3c01cbe8a3cf3a1a34ae"),
  }),
});
...
export interface Env {
  ...
  SELF: Mcp<{
    ...
    ["undefined"]: (input: UndefinedInput) => Promise<UndefinedOutput>;
  }>;
}

export const Scopes = {
  APIFY_CONTRACT: {
    CONTRACT_AUTHORIZE: "APIFY_CONTRACT::CONTRACT_AUTHORIZE",
    CONTRACT_GET: "APIFY_CONTRACT::CONTRACT_GET",
    CONTRACT_SETTLE: "APIFY_CONTRACT::CONTRACT_SETTLE",
    DECO_CHAT_OAUTH_START: "APIFY_CONTRACT::DECO_CHAT_OAUTH_START",
  },
};
