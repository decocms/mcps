...
export const createRecommendModelTool = (env: Env) =>
  createPrivateTool({
    ...
    description:
      ...
      "and suggests the most suitable Google Gemini models considering cost, quality, context length, and capabilities. " +
      "Each recommendation includes detailed reasoning explaining why the model is suitable. " +
      "Perfect for discovering the right Gemini model when you're not sure which to use.",
