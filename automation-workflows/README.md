...
- 🗄️ Read and write Make.com data stores
- 🔔 Inspect webhooks and automation triggers

## Authentication

Authentication is handled via OAuth through the MCP connection. Connect using the URL `https://mcp.make.com` and authorize with your Make.com account.
