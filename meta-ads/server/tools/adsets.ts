  ...
  createPrivateTool({
    ...
    execute: async ({ context }) => {
      ...
      return {
        ...
        ...(adset.budget_remaining !== undefined && {
          budget_remaining: adset.budget_remaining,
        }),
        ...(adset.bid_amount !== undefined && { bid_amount: adset.bid_amount }),
        ...(adset.bid_strategy !== undefined && {
          bid_strategy: adset.bid_strategy,
        }),
        ...(adset.billing_event !== undefined && {
          billing_event: adset.billing_event,
        }),
        ...(adset.optimization_goal !== undefined && {
          optimization_goal: adset.optimization_goal,
        }),
        ...(adset.targeting !== undefined && { targeting: adset.targeting }),
        ...(adset.promoted_object !== undefined && {
