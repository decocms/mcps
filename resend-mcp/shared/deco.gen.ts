...
export const StateSchema = z.object({
  apiKey: z
    .string()
    .describe("Resend API Key - Get it from https://resend.com/api-keys"),

  defaultFrom: z
    .string()
    .optional()
    .describe("Default sender email (e.g., 'Team <onboarding@resend.dev>')"),

  defaultFromName: z
    .string()
    .optional()
    .describe("Default sender name (used if defaultFrom is just an email)"),
});
